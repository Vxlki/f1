...
public:
    ...
    void setupUi(QDialog *SignInPage)
    {
        ...
        back->setGeometry(QRect(20, 460, 141, 41));
        SignIn = new QPushButton(SignInPage);
        SignIn->setObjectName("SignIn");
        SignIn->setGeometry(QRect(200, 460, 151, 41));
        label = new QLabel(SignInPage);
        label->setObjectName("label");
        label->setGeometry(QRect(450, 40, 381, 61));
        QFont font;
        ...
        comboBox->setGeometry(QRect(450, 130, 381, 31));
        comboBox_2 = new QComboBox(SignInPage);
        comboBox_2->setObjectName("comboBox_2");
        comboBox_2->setGeometry(QRect(450, 180, 381, 31));
        label_2 = new QLabel(SignInPage);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(450, 270, 381, 61));
        label_2->setFont(font);
        label_2->setFrameShape(QFrame::StyledPanel);
        comboBox_3 = new QComboBox(SignInPage);
        comboBox_3->setObjectName("comboBox_3");
        comboBox_3->setGeometry(QRect(450, 360, 381, 31));
        comboBox_4 = new QComboBox(SignInPage);
        comboBox_4->setObjectName("comboBox_4");
        comboBox_4->setGeometry(QRect(450, 410, 381, 31));
        comboBox_5 = new QComboBox(SignInPage);
        comboBox_5->setObjectName("comboBox_5");
        comboBox_5->setGeometry(QRect(450, 460, 381, 31));
